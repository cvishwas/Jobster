...
public class JavaBeans implements java.io.Serializable{
	...
	public String toString() {
		return "JavaBeans [userId=" + userId + ", jobId=" + jobId + ", firstName=" + firstName + ", lastName="
				+ lastName + ", address=" + address + ", city=" + city + ", state=" + state + ", country=" + country
				+ ", zip=" + zip + ", dateOfBirth=" + dateOfBirth + ", phoneNumber=" + phoneNumber + ", email=" + email
				+ ", schoolAttended=" + schoolAttended + ", degree=" + degree + ", major=" + major + ", gradDate="
				+ gradDate + ", gpa=" + gpa + ", companyName=" + companyName + ", jobTitle=" + jobTitle + ", dateStart="
				+ dateStart + ", dateEnd=" + dateEnd + ", workEligibility=" + workEligibility + "]";
	}
